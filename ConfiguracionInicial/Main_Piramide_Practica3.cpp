...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Cecilia Torres - Piramide con 7 cubos", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Cubo A
	    view = glm::translate(view, glm::vec3(0.0f,-8.0f, -19.0f));
		model = glm::rotate( model, 1.0f, glm::vec3( 0.0f, 1.0f, 0.0f ) ); // use to compare orthographic and perspective projection
		...
		//Cubo B
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.25f, 0.75f, 0.25f));
		model = glm::rotate(model, -45.0f, glm::vec3(0.0f, 0.5f, 0.0f));
		...
		//Cubo D
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.75f, 3.75f, -0.75f));
		...
		model = glm::rotate(model, -130.0f, glm::vec3(0.0f, 1.0, 0.0f));
		...
		//Cubo F
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(1.25f, 8.75f, 1.25f));
		model = glm::rotate(model, -345.0f, glm::vec3(0.0f, 1.0, 0.0f));
		...
		//Cubo G
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(1.5f, 13.0f, 1.5f));
		model = glm::rotate(model, 40.0f, glm::vec3(0.0f, 0.5, 1.0f));
