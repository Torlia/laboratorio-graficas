...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados - Previo 11 - Cecilia Torres", nullptr, nullptr);
...
void Animation() {
	...
	if (dogAnim == 1) { //Animacion caminata

		float limitePiso = 2.3f;
